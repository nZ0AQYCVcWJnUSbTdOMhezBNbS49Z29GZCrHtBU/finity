...
local mouse = blockware.gs["Players"].LocalPlayer:GetMouse()

function blockware:Create(class, properties)
...
function blockware:addShadow(object, transparency)
...
function blockware.new(isdark, gprojectName, thinProject)
	local blockwareObject = {}
	local self2 = blockwareObject
	local self = blockware

	if not blockware.gs["RunService"]:IsStudio() and self.gs["CoreGui"]:FindFirstChild(cachename) then
		warn("blockware:", "instance already exists in coregui!")
		
		return
	end

	local theme = blockware.theme
	local projectName = false
	local thinMenu = false
	
	if isdark == true then theme = blockware.dark_theme end
	...
	self2.ChangeToggleKey = function(NewKey)
		blockwareData.ToggleKey = NewKey
		
		if not projectName then
			self2.tip.Text = "Press '".. string.sub(tostring(NewKey), 14) .."' to hide this menu"
		end
		
		if blockwareData.UpConnection then
			blockwareData.UpConnection:Disconnect()
		end

		blockwareData.UpConnection = blockware.gs["UserInputService"].InputEnded:Connect(function(Input)
			if Input.KeyCode == blockwareData.ToggleKey and not typing then
                toggled = not toggled
	...
	function self2:Category(name)
		...
		category.button = blockware:Create("TextButton", {
			Name = name,
		...
		category.container = blockware:Create("ScrollingFrame", {
			Name = name,
			BackgroundTransparency = 1,
		...
		category.hider = blockware:Create("Frame", {
			Name = "Hider",
			BackgroundTransparency = 0, --
			BorderSizePixel = 0,
			BackgroundColor3 = theme.main_container,
		...
		category.L = blockware:Create("Frame", {
			Name = "L",
		...
		if not thinProject then
			category.R = blockware:Create("Frame", {
				Name = "R",
				AnchorPoint = Vector2.new(1, 0),
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
		...
		if firstCategory then
			blockware.gs["TweenService"]:Create(category.hider, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
			blockware.gs["TweenService"]:Create(category.container, TweenInfo.new(0.3), {ScrollBarImageTransparency = 0}):Play()
		end
		
		do
			local uilistlayout = blockware:Create("UIListLayout", {
				SortOrder = Enum.SortOrder.LayoutOrder
			})
	
			local uilistlayout2 = blockware:Create("UIListLayout", {
				SortOrder = Enum.SortOrder.LayoutOrder
			})
		...
		category.button.MouseEnter:Connect(function()
			blockware.gs["TweenService"]:Create(category.button, TweenInfo.new(0.2), {BackgroundTransparency = 0.5}):Play()
		end)
		category.button.MouseLeave:Connect(function()
			blockware.gs["TweenService"]:Create(category.button, TweenInfo.new(0.2), {BackgroundTransparency = 1}):Play()
		end)
			...
			for _, categoryf in next, self2.userinterface["Container"]["Categories"]:GetChildren() do
				if categoryf:IsA("ScrollingFrame") then
					if categoryf ~= category.container then
						blockware.gs["TweenService"]:Create(categoryf.Hider, TweenInfo.new(0.3), {BackgroundTransparency = 0}):Play()
						blockware.gs["TweenService"]:Create(categoryf, TweenInfo.new(0.3), {ScrollBarImageTransparency = 1}):Play()
					end
				end
			end

			blockware.gs["TweenService"]:Create(category.button, TweenInfo.new(0.2), {BackgroundTransparency = 0.2}):Play()
			blockware.gs["TweenService"]:Create(category.hider, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
			blockware.gs["TweenService"]:Create(category.container, TweenInfo.new(0.3), {ScrollBarImageTransparency = 0}):Play()
		...
		function category:Sector(name)
			...
			sector.frame = blockware:Create("Frame", {
				Name = name,
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
			...
			sector.container = blockware:Create("Frame", {
				Name = "Container",
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
			...
			sector.title = blockware:Create("TextLabel", {
				Name = "Title",
				Text = name,
				BackgroundColor3 = Color3.new(1, 1, 1),
				BackgroundTransparency = 1,
			...
			function sector:Cheat(kind, name, callback, data)
				...
				cheat.frame = blockware:Create("Frame", {
					Name = name,
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Size = UDim2.new(1, 0, 0, 25),
				...
				cheat.label = blockware:Create("TextLabel", {
					Name = "Title",
					BackgroundColor3 = Color3.new(1, 1, 1),
					BackgroundTransparency = 1,
					Size = UDim2.new(1, 0, 1, 0),
				...
				cheat.container	= blockware:Create("Frame", {
					Name = "Container",
				...
				if kind then
					if string.lower(kind) == "checkbox" or string.lower(kind) == "toggle" then
						...
						cheat.checkbox = blockware:Create("Frame", {
							Name = "Checkbox",
							AnchorPoint = Vector2.new(1, 0),
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.outerbox = blockware:Create("ImageLabel", {
							Name = "Outer",
							AnchorPoint = Vector2.new(1, 0.5),
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.checkboxbutton = blockware:Create("ImageButton", {
							AnchorPoint = Vector2.new(0.5, 0.5),
							Name = "CheckboxButton",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						if data then
							if data.enabled then
								blockware.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
								blockware.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
							end
						end
						...
						cheat.checkboxbutton.MouseEnter:Connect(function()
							...
							blockware.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = lightertheme}):Play()
						end)
						cheat.checkboxbutton.MouseLeave:Connect(function()
							if not cheat.value then
								blockware.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_outer}):Play()
							else
								blockware.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
							end
						end)
						cheat.checkboxbutton.MouseButton1Down:Connect(function()
							if cheat.value then
								blockware.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_outer}):Play()
							else
								blockware.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_checked}):Play()
							end
						end)
						cheat.checkboxbutton.MouseButton1Up:Connect(function()
							...
							if cheat.value then
								...
								blockware.gs["TweenService"]:Create(cheat.outerbox, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_outer}):Play()
								blockware.gs["TweenService"]:Create(cheat.checkboxbutton, TweenInfo.new(0.2), {ImageColor3 = theme.checkbox_inner}):Play()
							end
						end)
                    ...
                    elseif string.lower(kind) == "color" or string.lower(kind) == "colorpicker" then
                        ...
                        cheat.hsvbar = blockware:Create("ImageButton", {
							AnchorPoint = Vector2.new(0.5, 0.5),
							Name = "HSVBar",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
                        ...
                        cheat.arrowpreview = blockware:Create("ImageLabel", {
                            Name = "ArrowPreview",
                            BackgroundColor3 = Color3.new(1, 1, 1),
                            BackgroundTransparency = 1,
                        ...
                        cheat.hsvbar.MouseButton1Down:Connect(function()
                            local rs = blockware.gs["RunService"]
                            local uis = blockware.gs["UserInputService"]local last = cheat.value;
                            ...
                            while uis:IsMouseButtonPressed'MouseButton1' do
                                ...
                                blockware.gs["TweenService"]:Create(cheat.arrowpreview, TweenInfo.new(0.1), {Position = UDim2.new(position, 0, 0.5, -6)}):Play()
                        ...
                        cheat.hsvbar.MouseButton2Down:Connect(function()
                            local rs = blockware.gs["RunService"]
                            local uis = blockware.gs["UserInputService"]
					...
					elseif string.lower(kind) == "dropdown" then
						...
						cheat.dropdown = blockware:Create("ImageButton", {
							Name = "Dropdown",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Size = UDim2.new(1, 0, 1, 0),
						...
						cheat.selected = blockware:Create("TextLabel", {
							Name = "Selected",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.list = blockware:Create("ScrollingFrame", {
							Name = "List",
						...
						uilistlayout = nil
						local uipadding = blockware:Create("UIPadding", {
							PaddingLeft = UDim.new(0, 2)
						})
						...
						local function refreshOptions()
							...
							for _, value in next, options do
								local button = blockware:Create("TextButton", {
									BackgroundColor3 = Color3.new(1, 1, 1),
									BackgroundTransparency = 1,
								...
								button.MouseEnter:Connect(function()
									blockware.gs["TweenService"]:Create(button, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text_hover}):Play()
								end)
								button.MouseLeave:Connect(function()
									blockware.gs["TweenService"]:Create(button, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text}):Play()
								end)
								...
								blockware.gs["TweenService"]:Create(button, TweenInfo.new(0), {TextTransparency = 1}):Play()
							end
							
							blockware.gs["TweenService"]:Create(cheat.list, TweenInfo.new(0), {Size = UDim2.new(1, 0, 0, 0), Position = UDim2.new(0, 0, 1, 0), CanvasSize = UDim2.new(0, 0, 0, cheat.list["UIListLayout"].AbsoluteContentSize.Y), ScrollBarImageTransparency = 1, BackgroundTransparency = 1}):Play()
						end
							...
							if cheat.dropped then
								for _, button in next, cheat.list:GetChildren() do
									if button:IsA("TextButton") then
										blockware.gs["TweenService"]:Create(button, TweenInfo.new(0.2), {TextTransparency = 0}):Play()
									end
								end

								blockware.gs["TweenService"]:Create(cheat.list, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, math.clamp(cheat.list["UIListLayout"].AbsoluteContentSize.Y, 0, 150)), Position = UDim2.new(0, 0, 1, 0), ScrollBarImageTransparency = 0, BackgroundTransparency = 0.5}):Play()
							else
								for _, button in next, cheat.list:GetChildren() do
									if button:IsA("TextButton") then
										blockware.gs["TweenService"]:Create(button, TweenInfo.new(0.2), {TextTransparency = 1}):Play()
									end
								end

								blockware.gs["TweenService"]:Create(cheat.list, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 0, 0), Position = UDim2.new(0, 0, 1, 0), ScrollBarImageTransparency = 1, BackgroundTransparency = 1}):Play()
							end
						end

						cheat.dropdown.MouseEnter:Connect(function()
							blockware.gs["TweenService"]:Create(cheat.selected, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text_hover}):Play()
						end)
						cheat.dropdown.MouseLeave:Connect(function()
							blockware.gs["TweenService"]:Create(cheat.selected, TweenInfo.new(0.1), {TextColor3 = theme.dropdown_text}):Play()
						end)
					...
					elseif string.lower(kind) == "textbox" then
						...
						cheat.background = blockware:Create("ImageLabel", {
							Name = "Background",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Size = UDim2.new(1, 0, 1, 0),
						...
						cheat.textbox = blockware:Create("TextBox", {
							Name = "Textbox",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.background.MouseEnter:Connect(function()
							blockware.gs["TweenService"]:Create(cheat.textbox, TweenInfo.new(0.1), {TextColor3 = theme.textbox_text_hover}):Play()
						end)
						cheat.background.MouseLeave:Connect(function()
							blockware.gs["TweenService"]:Create(cheat.textbox, TweenInfo.new(0.1), {TextColor3 = theme.textbox_text}):Play()
						end)
						cheat.textbox.Focused:Connect(function()
							typing = true

							blockware.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.textbox_background_hover}):Play()
						end)
						cheat.textbox.FocusLost:Connect(function()
							typing = false

							blockware.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.textbox_background}):Play()
							blockware.gs["TweenService"]:Create(cheat.textbox, TweenInfo.new(0.1), {TextColor3 = theme.textbox_text}):Play()
					...
					elseif string.lower(kind) == "slider" then
						...
						cheat.sliderbar = blockware:Create("ImageButton", {
							Name = "Sliderbar",
							AnchorPoint = Vector2.new(1, 0.5),
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.numbervalue = blockware:Create("TextLabel", {
							Name = "Value",
						...
						cheat.visiframe = blockware:Create("ImageLabel", {
							Name = "Frame",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
						...
						cheat.sliderbar.MouseButton1Down:Connect(function()
							...
							blockware.gs["TweenService"]:Create(cheat.visiframe, TweenInfo.new(0.1), {
								Size = UDim2.new(size / 150, 0, 1, 0),
								ImageColor3 = theme.slider_color_sliding
							}):Play()

							blockware.gs["TweenService"]:Create(cheat.numbervalue, TweenInfo.new(0.1), {
							...
							releaseconnection = blockware.gs["UserInputService"].InputEnded:Connect(function(Mouse)
					...
					elseif string.lower(kind) == "button" then
						...
						cheat.button = blockware:Create("TextButton", {
							Name = "Button",
							BackgroundColor3 = Color3.new(1, 1, 1),
							BackgroundTransparency = 1,
							Position = UDim2.new(0, 0, 0, 0),
						...
						cheat.button.MouseEnter:Connect(function()
							blockware.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.button_background_hover}):Play()
						end)
						cheat.button.MouseLeave:Connect(function()
							blockware.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.button_background}):Play()
						end)
						cheat.button.MouseButton1Down:Connect(function()
							blockware.gs["TweenService"]:Create(cheat.background, TweenInfo.new(0.2), {ImageColor3 = theme.button_background_down}):Play()
						end)
					...
					elseif string.lower(kind) == "keybind" or string.lower(kind) == "bind" then
						...
						cheat.button.MouseButton1Up:Connect(function()
							...
							connection = blockware.gs["UserInputService"].InputBegan:Connect(function(Input)
								if Input.UserInputType.Name == "Keyboard" and Input.KeyCode ~= blockwareData.ToggleKey and Input.KeyCode ~= Enum.KeyCode.Backspace then
								...
								elseif Input.KeyCode == Enum.KeyCode.Backspace then
									...
									connection:Disconnect()
									connection = nil
								elseif Input.KeyCode == blockwareData.ToggleKey then
						...
						blockware.gs["UserInputService"].InputBegan:Connect(function(Input, Process)
	...
	if not blockware.gs["RunService"]:IsStudio() then
